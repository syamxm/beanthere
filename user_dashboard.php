  ...
  <section class="review" id="review">
    ...
    <div class="box-container">
      ...
      <div class="box">
        ...
        <img loading="lazy" src="images/user1.jpg" class="user" alt="User">
        <h3>Jane Smith</h3>
        <div class="stars">⭐⭐⭐⭐⭐</div>
      </div>
      ...
      <div class="box">
        ...
        <img loading="lazy" src="images/user2.jpg" class="user" alt="User">
        <h3>Ali Rahman</h3>
        <div class="stars">⭐⭐⭐⭐⭐</div>
      </div>
      ...
      <div class="box">
        ...
        <img loading="lazy" src="images/user3.jpg" class="user" alt="User">
        <h3>Sophia Lee</h3>
        <div class="stars">⭐⭐⭐⭐</div>
      </div>
